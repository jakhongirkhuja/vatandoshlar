        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{$menu->title}} {{$categoryName && $categoryName->category? '| '.$categoryName?->category : ''}}</h2>
                ...
                <table class="table data-list-view dataTable">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            <td width="100">
                                @include('admin.components.sort-form', ['menu' => $section,'route' => route('admin.pages.section.update-sort', ['slug'=>$slug,'id' => $id,'section_id'=>$section->id])])
                            </td>
                            <td width="100">
                            ...
                            <td class="fx align-items-center">
                                ...
                                @endphp
                                <a href="{{ route('admin.pages.section.edit',$parameters) }}" class="btn btn-small btn-info mr-1">
                                ...
                                <a href="#"
                                    ...
                                    data-id="{{ $section->id }}"
                                    data-url="{{ route('pages.delete',$section->id) }}">
