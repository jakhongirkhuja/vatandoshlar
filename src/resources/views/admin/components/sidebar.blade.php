        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item ">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{is_current_route('admin.roles') ? 'active' : ''}}"><a href="{{route('admin.roles')}}"><i
                                class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Roles</span></a>
                    </li>
                    <li class="{{is_current_route('langs.index') ? 'active' : ''}}"><a href="{{route('langs.index')}}"><i
                                class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Lang</span></a>
                    </li>
