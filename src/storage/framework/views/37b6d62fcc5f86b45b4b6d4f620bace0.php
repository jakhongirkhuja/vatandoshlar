                ...
                <div class="locations">
                    <div class="select-wrapper">
                        <select name="regions" id="regions">
                            <option value="" selected disabled><?php echo e(staticValue('cities')); ?></option>
                            <?php
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/locations/index.blade.php ENDPATH**/ ?>