                                                ...
                                                @if($setting->is_translatable)
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if($setting->type == 'textarea' || $setting->type == 'textarea-editor')
                                                            <textarea
                                                                class="form-control {{$setting->type == 'textarea-editor' ? 'summernote' : ''}}"
                                ...
                                @foreach($settings as $setting)
                                    @if(!$setting->is_translatable)
                                        ...
                                        <div class="form-group">
                                            ...
                                            @elseif($setting->type == 'datetime-local')
                                                <input type="datetime-local" class="form-control" name="fields[{{ $setting->key }}]"
                                                    value={{ $value }}>
                                            @elseif($setting->type == 'select')
                                            ...
                                            @else
                                                ...
                                                @php $type = $setting->type == 'text' ? 'text' : 'number' @endphp
                                                <input type="{{$type}}" class="form-control" name="fields[{{ $setting->key }}]"
                                                    value="{{$value2 }}">
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="parent_id" class="form-control select2 select2-single-multiple" multiple>
                                                ...
                                                @foreach($menus as $parent)
                                                                                        <option value="{{ $parent->id }}" {{ old('parent_id', $menu->parent_id ??
                                                    '') == $parent->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" class="form-control" id="menu-type" required>
                                                @foreach(['page', 'category', 'section', 'url'] as $type)
                                                                                        <option value="{{ $type }}" {{ old('type', $menu->type ?? '') == $type ?
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <div class="custom-control custom-switch  mb-1">
                                                <p class="mb-0">Test</p>
                                                <input type="checkbox" class="custom-control-input" name="test" {{
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <div class="custom-control custom-switch  mb-1">
                                                ...
                                                <input type="checkbox" class="custom-control-input" name="show_admin" {{
        ...
        old('status', $menu->status ?? true) ? 'checked' : '' }}
                        ...
                        <div class="row mt-3">
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <button type="submit"
                                    class="btn btn-primary px-3">{{ $isEdit ? 'Обновить' : 'Сохранить' }}</button>
                            </div>
                        </div>
