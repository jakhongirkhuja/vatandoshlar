                    ...
                    <table class="table data-list-view dataTable">
                        ...
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($menu->parent_id === null): ?>
                                <?php echo $__env->make('admin.components.menu-row', ['menu' => $menu, 'menus' => $menus, 'level' => 0], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?>
...
<script>
    ...
    function updateSortOrder(ul) {
        ...
        fetch(`<?php echo e(route('admin.menu_main.update-sort-menu',)); ?>`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/admin/pages/menus/main/index.blade.php ENDPATH**/ ?>