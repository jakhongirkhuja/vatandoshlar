            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item  mr-auto"><a class="nav-link nav-menu-main update_header_menu" href="{{route('admin.settings')}}"><i class="ficon feather icon-settings"></i>Настройки сайта</a></li>
                        <li class="nav-item  mr-auto"><a class="nav-link nav-menu-main update_header_menu" target="_blank" href="{{route('home')}}"><i class="ficon feather icon-external-link"></i>Перейти на сайт </a></li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            @php
                               $user = auth()->user();
                             @endphp
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ $user->name}}</span><span class="user-status">{{ $user->status?'Active':'Inactive'}}</span></div><span><img class="round" src="{{asset('assets/admin')}}/app-assets/images/portrait/small/icon.png" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{route('logout')}}"><i class="feather icon-power"></i> Выйти</a>
                        </div>
                    </li>
                </ul>
            </div>
