        ...
        <div class="layout-content">
            ...
            <div class="projects-hero">
                ...
                <div class="projects-hero__content">
                    <p style=" color: white;margin-bottom: 20px;"> {{ formatLocalizedDate(sectionValue($projects,
                        'last_date'),'date') }}</p>
                    ...
                    <div class="projects-hero__wrapper">
                        <a data-bs-toggle="modal" data-bs-target="#ReqModel"
                            class="button projects-hero__wrapper--btn">{{staticValue('requirements')}}</a>
                    ...
                    <div class="modal-content projects-requirement__wrapper">
                        <div class="projects-requirement__wrapper--inner">
                            <div class="projects-requirement__content">
                                <h5 class="projects-requirement__content--title">{{ sectionValue($projects, 'content')
                                    }}</h5>
                                <div class="projects-requirement__content--text">
                                    {!! sectionValue($projects, 'description1') !!}
                                </div>
                                ...
                                <div class="projects-requirement__content--buttons">
                                    <a href="{{ route('home', ['locale' => app()->getlocale(), 'any' => request()->route('any'), 'inside' => $projects->slug, 'detail' => 'ariza-topshirish']) }}"
                                        class="button">{{staticValue('more')}}</a>
                                    <button class="button" data-bs-dismiss="modal">{{staticValue('cancel')}}</button>
                                </div>
                            </div>
                            <div class="projects-requirement__img">
                                @if(!empty($projectModalImage) && isset($projectModalImage[0]))
                                <img src="{{ $projectModalImage[0] }}" alt="">
                                @endif
                            </div>
                        </div>
            ...
            <div class="projects-categories">
                ...
                <div class="projects-categories__item">
                    ...
                    @endphp
                    <a
                        href="{{ route('home', ['locale' => app()->getLocale(), 'any' => request()->route('any'), 'inside' => $category->slug]) }}">
            ...
            <div class="projects-video mb-4">
                ...
                <div class="carousel carousel3 owl-carousel ">
                    ...
                    <a class="carousel__item video-card" data-fancybox="" href="{{ $src }}">
                        ...
                        <div class="carousel__item--content">
                            ...
                            <p class="carousel__item--content-date"><i class="i-calendar"></i><span>
                                    {{ date('d-m-Y', strtotime($section->publish_at))}}</span>
                        </div>
                    </a>
                    @endforeach
                    @endforeach
                ...
                <div class="seasons-navigation">
                    ...
                    <div class="seasons-year-selector">
                        ...
                        <div class="current-year-text">
                            ...
                            @foreach ($projects->children as $k => $projectYear)
                            <button class="year-label {{ $k == 0 ? 'active' : 'next' }}">{{sectionValue(
                                $projectYear,
                                'title'
                                )}}</button>
