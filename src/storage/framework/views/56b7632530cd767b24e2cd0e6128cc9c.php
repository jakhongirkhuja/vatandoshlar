                    ...
                    <div class="locations">
                        <div class="select-wrapper">
                            <select name="regions" id="regions">
                                <option value="" selected>Barcha viloyatlar</option>
                            </select>
                        </div>
                        <svg class="map" xmlns="http://www.w3.org/2000/svg" id="map" width="729" height="475" fill="none"
                            ...
                            <?php
                                $items = $items->skip(1);
                            ?>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/front/pages/location/index.blade.php ENDPATH**/ ?>