...
class ContentStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'images.*' => 'file|mimes:jpeg,jpg,png,gif,svg,mp4,webm,ogg,mov,avi,pdf|max:1024000',
    ...
    public function messages(): array
    {
        return [
            ...
            'images.*.mimes' => 'Допустимые форматы: изображения (jpg, png, svg, pdf) или видео (mp4, mov, avi).',
            'images.*.max' => 'Максимальный размер файла — 1050 МБ.',
