        ...
        <div class="layout-content">
            <div class="content">
                ...
                <div class="content__text">
                    ...
                    <div class="carousel carousel3center owl-carousel">
                        ...
                        <div class="carousel__item" style="pointer-events: none;">
                            <a class="carousel__item--img" data-fancybox=""
                                href="<?php echo e(sectionValue($middleItem, 'url')); ?>">
                ...
                <div class="carousel carousel3 owl-carousel">
                    ...
                    <?php if($mainImage): ?>
                    <?php $__currentLoopData = $mainImage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(sectionValue($item, 'url')); ?>" data-fancybox class="carousel__item video-card">
                        ...
                        <div class="carousel__item--content">
                            ...
                            <p class="carousel__item--content-date">
                                ...
                                <span><?php echo e(formatLocalizedDate(sectionValue($item, 'date'),true)); ?></span>
                            </p>
                        </div>
                    </a>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/uzbekistan/index.blade.php ENDPATH**/ ?>