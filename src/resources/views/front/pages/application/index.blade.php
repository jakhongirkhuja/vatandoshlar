                ...
                <form class="apply-form" action="{{ route('support.create') }}" id="myForm" method="post">
                    ...
                    <div class="form-row form-row--name-date">
                        <div class="form-field">
                            ...
                            <input type="text" id="fullname" name="data[name]" class="form-control" placeholder="{{staticValue('info-add')}}" required>
                        </div>

                        <div class="form-field">
                            <label for="birthdate">{{staticValue('birthdate')}}</label>
                            <input type="date" id="birthdate" placeholder="DD-MM-YYYY" name="data[birthdate]" class="form-control" required>
                        </div>
                    </div>

                    <div class="form-field">
                        <label for="specialization">{{staticValue('Specialization:')}}</label>
                        <input type="text" name="data[job]" class="form-control" placeholder="{{staticValue('select_spec')}}" required>
                    </div>

                    <div class="form-field">
                        <label for="address">{{staticValue('turar-joy')}}</label>
                        <input type="text" id="address" name="data[address]" class="form-control" placeholder="{{staticValue('the_address')}}" required>
                    </div>

                    <div class="form-field">
                        <label for="extra_info">{{staticValue('add-info')}}</label>
                        <input type="text" id="extra_info" name="data[extra_info]" class="form-control" placeholder="{{staticValue('contact-info')}}" required>
                    </div>
                    <div class="form-field">
                        <label for="description">{{staticValue('taklif')}}</label>
                        <input type="text" id="description" name="data[description]" class="form-control" placeholder="{{staticValue('info-add')}}" required>
                    </div>
