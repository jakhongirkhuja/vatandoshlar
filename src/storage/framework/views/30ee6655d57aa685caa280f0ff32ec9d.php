            ...
            <div class="layout-content">
                <div class="content">
                    ...
                    <div class="content__grid gtc-3">
                            <a class="content__grid--item video-card" href="<?php echo e(sectionValue($item,'url')); ?>">
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/qadriyatlar/index.blade.php ENDPATH**/ ?>