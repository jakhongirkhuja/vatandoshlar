            ...
            <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-md-10">
                            @php
                                $param = request()->route('type');
                                $type = 'Form';
                                if($param=='application'){
                                    $type = 'Murojaatlar (Asisiy sahifa)';
                                }elseif ($param=='participation'){
                                    $type = 'Loyihalar ariza';
                                }elseif ($param=='form'){
                                    $type="Bog'lanish";
                                }elseif ($param=='textError'){
                                    $type="Matndagi xatolar";
                                }
                            @endphp
                            <h2 class="content-header-title float-left mb-0">{{$type}} </h2>
                        ...
                        <div class="col-md-2 text-right">
                            <a href="{{route('admin.support.export',['type'=>$param])}}" class="btn btn-primary" target="_blank">Export</a>
                                                    ...
                                                    <tr class="{{$support->user_id? '' : 'bold'}}">
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                if($support->type=='textError'){
                                                                    $text =isset($data['selectedText']) ? $data['selectedText'] : 'no text';
                                                                }else{
                                                                    $text =isset($data['name']) ? $data['name'] : 'no name';
                                                                }
                                                            @endphp
                                                            {{  substr($text, 0,100) }}
                                                        </td>
