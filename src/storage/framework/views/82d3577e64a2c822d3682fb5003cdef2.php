    <script>
        ...
        <section class="press">
            <div class="container">
                <div class="section-top">
                    ...
                    ?>
                    <a href="<?php echo e(route('home',['locale' => app()->getLocale(),'any' => $newsp->slug])); ?>"><?php echo e(staticValue('all')); ?></a>
                </div>
                <div class="press__wrapper">
                    ...
                    <div class="press__right">
                        ...
                        <a href="<?php echo e(route('home',['locale' =>  app()->getLocale(),'any' => $newsp->slug,'inside' => $newspaper->slug])); ?>" class="press__right--item">
        ...
        </section><?php /**PATH /var/www/html/resources/views/front/home/press.blade.php ENDPATH**/ ?>