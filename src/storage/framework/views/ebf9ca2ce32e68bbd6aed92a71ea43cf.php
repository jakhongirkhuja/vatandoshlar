<ul class="header__menu">
                ...
                <li class="header__submenu-item <?php echo e($menu->childrens->count() ? 'header__menu-item--dropdown' : ''); ?>">
                    ...
                    <?php if($menu->childrens->count()): ?>
                        <ul class="header__submenu">
                            <?php echo $__env->make('front.components.navbar', ['headerMenu' => $menu->childrens], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        </ul><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/components/navbar.blade.php ENDPATH**/ ?>