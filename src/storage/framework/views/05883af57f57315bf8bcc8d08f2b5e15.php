                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="container">
                                ...
                                <form action="<?php echo e(route('admin.menu_main.settings.create')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="card p-3 mb-3 field-item">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-2">
                                                    <label>Key</label>
                                                    <input type="text" required name="fields[<?php echo e($index); ?>][key]"
                                                        class="form-control" value="<?php echo e($f->key); ?>">
                                                </div>
                                                <div class="col-md-12 mb-2">
                                                    <label>Label</label>
                                                    <input type="text" required name="fields[<?php echo e($index); ?>][label]"
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    ...
                                                    <select name="fields[<?php echo e($index); ?>][type]"
                                                        ...
                                                        <option value="number" <?php echo e($f->type=='number'?'selected':''); ?>>Integer</option>
                                                         <option
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <button class="btn btn-success">Sozlamalarni saqlash</button>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/admin/pages/menus/main/settings.blade.php ENDPATH**/ ?>