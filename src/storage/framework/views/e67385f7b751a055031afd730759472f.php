                    ...
                    <div class="associations__view--grid">
                        ...
                        <div class="associations__view--grid-item">
                            ...
                            <div class="associations__view--grid-item-content">
                                ...
                                <a
                                    href="<?php echo e(route('home', ['locale' => app()->getLocale(), 'any' => $currentPage->slug,'inside'=>request()->route('inside') ,'detail' => $item->slug])); ?>">
                                    <?php echo e(staticValue('more')); ?> <i class="i-link"></i>
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/associations/inside/index.blade.php ENDPATH**/ ?>