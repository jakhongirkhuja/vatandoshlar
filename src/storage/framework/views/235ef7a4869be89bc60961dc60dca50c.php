            ...
            <div class="layout-content">
                <div class="content">
                    ...
                    <div class="tab-navigation international-partnership__navigation">
                       ...
                       <?php echo e(staticValue('map')); ?>

                        </button>
                        <button data-tab-system="1" class="tab-button">
                        <?php echo e(staticValue('grid')); ?>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/associations/index.blade.php ENDPATH**/ ?>