...
<style>
    * {
    ...
    body {
        ...
        align-items: center;
        text-align: center;
        background: url("{{ asset('front/images/construction-bg.png') }}") no-repeat center center/cover;
        color: #fff;
...
<img src="{{ asset('front/images/construction-main.png') }}" style="width: min(70vw, 60vh);"
