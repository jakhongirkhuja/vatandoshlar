                ...
                <div class="associations-detail__about">
                    ...
                    <div class="associations-detail__about--text">
                        ...
                        <div class="associations-detail__about--text-task">
                            <p><?php echo e(staticValue('aim')); ?></p>
                ...
                <div class="associations-detail__president">
                    ...
                    <div class="associations-detail__president--data">
                        ...
                        <div class="associations-detail__president--data-contact">
                            ...
                            <div class="associations-detail__president--data-contact-item">
                                <p><?php echo e(staticValue('email_info')); ?></p>
                ...
                <div class="associations-detail__news">
                    ...
                    <div class="carousel carousel3 owl-carousel">
                        ...
                        <a class="carousel__item"
                            href="<?php echo e(route('home', ['locale' => app()->getLocale(), 'any' =>$newsSlug->slug, 'inside' => $newsItem->slug])); ?>">
                            <div class="carousel__item--img">
                                <?php
                            ...
                            <div class="carousel__item--content">
                                <p class="carousel__item--content-title line-clamp-2"><?php echo e(sectionValue($newsItem,
                                    'title')); ?></p>
                                <p class="carousel__item--content-date">
                                    <i class="i-calendar"></i>
                                    <span><?php echo e(date('Y-m-d', strtotime($newsItem->publish_at))); ?></span>
                                </p>
                            </div>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/associations/inside/detail/index.blade.php ENDPATH**/ ?>