...
<div class="layout">
    <div class="container">
        <div class="layout-content">
            ...
            <?php else: ?>
            <a href="https://youtu.be/rDXfi9iHg8M?si=oXdabuH4MdnVfA3D" class="about__page--video fancybox"
                data-fancybox>
                <?php
                $image = sectionImages($item, true);
                ?>
                <img src="<?php echo e($image); ?>" alt="">
                <div class="play"><img src="<?php echo e(asset('front/images/play2.svg')); ?>" alt=""></div>
            </a>
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/aboutus/index.blade.php ENDPATH**/ ?>