        ...
        <div class="content-header row">
            ...
            <div class="col-md-4">
                <form method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control round" placeholder="Qidirish" name="s" value="{{request()->s}}">
            ...
            <div class="content-header-right text-md-right col-md-3 d-md-block">
                ...
                <div class="form-group breadcrum-right ">
                    ...
                    <a href="{{route('admin.content.create', ['category' => request()->route('category')])}}" class="btn btn-primary pull-right waves-effect waves-light" type="button">
                        <i class="feather icon-plus icon-white"></i>
                        <span>Qo'shish</span>
                    </a>
                    <a href="{{route('admin.content.settings', ['category' => request()->route('category')])}}" class="btn btn-primary pull-right waves-effect waves-light mr-2" type="button">
                ...
                <table class="table data-list-view dataTable">
                    ...
                    <tbody id="sortable">
                        ...
                        <tr data-id="{{ $content->id }}">
                            <td>
                                {{ \Illuminate\Support\Str::limit(sectionValue($content, 'title'), 150) }}
                            ...
                            <td class="fx align-items-center">
                                ...
                                <div class="custom-control custom-switch custom-control-inline">
                                    <input type="checkbox" name="status" class="custom-control-input lang-status-switch" id="customSwitch{{ $content->id }}" data-id="{{ $content->id }}" @checked($content->status)>
                                    <label class="custom-control-label" for="customSwitch{{ $content->id }}"></label>
                                </div>

                                <a href="#" class="btn btn-small btn-danger ml-2 delete-btn" data-id="{{ $content->id }}" data-url="{{ route('admin.content.delete', [$content->id, 'category' => request()->route('category')]) }}">
