        ...
        <form class="apply-form" action="<?php echo e(route('participation.create')); ?>" method="post">
            ...
            <div class="form-row form-row--name-date">
                ...
                <div class="form-field">
                    ...
                    <input type="date" id="birthdate" placeholder="DD-MM-YYYY" name="data[birthdate]" class="form-control"
                        required>
                </div>
            </div>
            ...
            <div class="form-row form-row--three">
                ...
                <div class="form-field">
                    ...
                    <input type="email" id="email" name="data[email]" class="form-control" placeholder="example@gmail.com"
                        required>
                </div>
                <div class="form-field">
            ...
            <div class="form-row form-row--two">
                <div class="form-field">
                    ...
                    <input type="text" id="workplace" name="data[workplace]" class="form-control" placeholder="Kiriting"
                        required>
                </div>
                <div class="form-field">
                    <label for="position">Lavozimi:</label>
                    <input type="text" id="position" name="data[position]" class="form-control" placeholder="Kiriting"
                        required>
                </div>
            </div>
            ...
            <div class="form-row form-row--two">
                <div class="form-field">
                    ...
                    <input type="text" id="education" name="data[education]" class="form-control" placeholder="Kiriting">
                </div>
                <div class="form-field">
            ...
            <div class="form-row form-row--three">
                <div class="form-field">
                    ...
                    <input type="text" id="telegram" name="data[telegram]" class="form-control" placeholder="Kiriting">
                </div>
                <div class="form-field">
                    <label for="instagram">Instagram:</label>
                    <input type="text" id="instagram" name="data[instagram]" class="form-control" placeholder="Kiriting">
                </div>
                <div class="form-field">
                    <label for="whatsapp">WhatsApp:</label>
                    <input type="text" id="whatsapp" name="data[whatsapp]" class="form-control" placeholder="Kiriting">
                </div>
            </div>
