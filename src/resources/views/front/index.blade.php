                ...
                <ul class="about-section__left">
                    @foreach(linkData() as $link)
                        <li class="about-section__left-item">
                            <a class="about-section__left--link" href="{{ $link->url }}" target="_blank"
...
])}}">{{staticValue('all')}}<i class="i-link"></i></a>
                </div>
                ...
                <div class="press__wrapper">
                    ...
                    <div class="press__right">
                        @foreach ($newspapers as $newspaper)
                            <a href="{{route('home', ['locale' => app()->getLocale(), 'any' => $newsp->slug, 'inside' => $newspaper->slug])}}"
                ...
                <div class="president__wrapper">
                    @if($item)
                        ...
                        <div class="president__left">
                            <img src="{{ sectionImages($item, true) }}" width="520"
                                 alt="{{ sectionValue($item, 'title') }}">
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="social__wrapper">
                    ...
                    <div class="social__card">
                        <div class="social__card--content">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a class="link" href="{{sectionValue($social1,'link1')}}" target="_blank"><img
                                            src="{{ asset('front') }}/images/appstore.svg" alt=""></a>
                                <a class="link" href="{{sectionValue($social1,'link2')}}" target="_blank"><img
                                            src="{{ asset('front') }}/images/googleplay.svg" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="social__card">
                        <div class="social__card--content">
                            ...
                            <a class="button" href="{{sectionValue($social2,'link1')}}"
                               target="_blank">{{staticValue('keyboard')}}</a>
                        </div>
                        <div class="social__card--img">
                            @php
                ...
                <div class="library__section--wrapper">
                    ...
                    <div class="library__section--right">
                        ...
                        <div class="carousel library-carousel1">
                            @for($i = 0; $i < 2; $i++)
                                @foreach($libraryBooks as $item)
                                    @php $image=sectionImages($item, true);
                                    @endphp <img src="{{$image }}" alt="">
                                @endforeach
                            @endfor
                        </div>
                    ...
                    <div class="contacts__right">
                        ...
                        <div class="contacts__right--wrapper">
                            @if(staticValue('button1'))
                                <a class="button"
                                   href="{{ route('home', ['locale' => app()->getlocale(), 'any' => 'contacts']) }}">{{staticValue('button1')}}</a>
                            @endif
                            <a class="link" data-fancybox=" gallery" href="{{staticValue('video_l', 'url')}}"><i
                                        class="i-play"></i><span>{{staticValue('video_l')}}</span></a>
                        </div>
                    </div>
                ...
                <div class="join-us__content">
                    ...
                    @if(staticValue('button1'))
                        <a class="join-us__content--btn"
                           href="{{ route('home',['locale'=>app()->getlocale(), 'any'=>'application']) }}">
                            {{ staticValue('button1') }}
                        </a>
                    @endif
                </div>
