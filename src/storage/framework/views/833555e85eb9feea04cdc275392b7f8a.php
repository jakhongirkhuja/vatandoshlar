                ...
                <?php if($projects): ?>
                    <div class="projects-hero">
                        ...
                        <div class="projects-hero__content">
                            ...
                            <?php echo e(sectionValue($projects,'last_date')); ?>


                            <div class="projects-hero__wrapper">
                                <a href="<?php echo e(sectionValue($projects,'url')); ?>" class="button projects-hero__wrapper--btn">Tanlov shartlari</a>
                                <a href="<?php echo e(route('home',['locale'=>app()->getlocale(), 'any'=>request()->route('any'),'inside'=>$projects->slug,'detail'=>'ariza-topshirish'])); ?>" class="button projects-hero__wrapper--btn">Ishtirok etish</a>
                            </div>
                    ...
                    <div class="carousel carousel3 owl-carousel ">
                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $mainImage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="carousel__item video-card" href="<?php echo e($src); ?>">
                                    ...
                                    <div class="carousel__item--content">
                                        ...
                                        <p class="carousel__item--content-date"><i
                                                class="i-calendar"></i><span><?php echo e($section->created_at->toDateString()); ?>5</span>
                                        </p>
                                    </div>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="seasons-navigation">
                        ...
                        <div class="seasons-year-selector">
                            ...
                            <div class="current-year-text">
                                ...
                                <?php $__currentLoopData = $projects->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $projectYear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button
                                        class="year-label <?php echo e($k == 0 ? 'active' : 'next'); ?>"><?php echo e(sectionValue($projectYear, 'title')); ?></button>
...
<?php echo $__env->make('front.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/pages/barcha_loyihalar/inside/index.blade.php ENDPATH**/ ?>