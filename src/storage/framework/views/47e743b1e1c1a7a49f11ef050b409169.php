<header class="header" role="banner">
    <div class="container">
        ...
        <form class="header__search--wrapper" action="<?php echo e(route('search', ['locale'=> app()->getLocale()])); ?>" method="get">
            <input class="form-control" name="search" placeholder="<?php echo e(staticValue('search')); ?>">
        </form>
