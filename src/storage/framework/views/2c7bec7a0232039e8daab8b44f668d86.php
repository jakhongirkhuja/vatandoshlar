                                        ...
                                        <table class="table table-hover-animation mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="<?php echo e($support->user_id? '' : 'bold'); ?>">
                                                        <td >
                                                            <?php echo e($support->created_at->format('Y-m-d H:i')); ?></b>
                                                        </td>
                                                        <td>
                                                            <?php
                                                                $data = $support->data;
...
<?php echo $__env->make('admin.layouts.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/admin/pages/support/index.blade.php ENDPATH**/ ?>