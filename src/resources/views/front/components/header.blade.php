<header class="header" role="banner">
    <div class="container">
        ...
        <form class="header__search--wrapper" action="{{ route('search', ['locale'=> app()->getLocale()]) }}" method="get">
            <input class="form-control" name="search" placeholder="{{staticValue('search')}}">
        </form>
