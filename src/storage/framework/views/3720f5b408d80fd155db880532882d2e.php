...
<section class="press">
    <div class="container">
        <div class="section-top">
            ...
            ?>
            <a href="<?php echo e(route('home', ['locale' => app()->getLocale(), 'any' => $newsp->slug])); ?>"><?php echo e(staticValue('all')); ?><i
                    class="i-link"></i></a>
        </div>
...
</section><?php /**PATH /var/www/vatandoshlar_usr36/data/www/vatandoshlar.7z7.uz/resources/views/front/home/press.blade.php ENDPATH**/ ?>