...
Route::middleware(CheckSiteStatus::class)->group(function () {
    Route::post('reportTextError', [SupportController::class, 'reportTextError'])->name('reportTextError');
    ...
    Route::get('download/newspaper/{id}', [HomeController::class, 'downloadSection'])->name('downloadSection');
