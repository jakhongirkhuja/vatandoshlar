                        ...
                        <?php if(isset($menu)): ?>
                            ...
                            <?php $__currentLoopData = $menu->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <li class="thumb <?php echo e($image->main ? 'main' : ''); ?>" data-id="<?php echo e($image->id); ?>">
                                    <?php if($isVideo): ?>
                                        <a href="<?php echo e(asset('storage/' . $image->image)); ?>" class="thumbnail fancybox tooltips" rel="group">
                                            <video style="width: 180px; height: 180px; object-fit: cover;" controls>
                                                <source src="<?php echo e(asset('storage/' . $image->image)); ?>" type="video/<?php echo e($fileExtension); ?>">
                                                Your browser does not support the video tag.
                                            </video>
                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(asset('storage/' . $image->image)); ?>" class="thumbnail fancybox tooltips" rel="group">
                                            <img src="<?php echo e(asset('storage/' . $image->image)); ?>" style="width: 180px; height: 180px; object-fit: cover;">
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    <div class="toolbar">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-mini ajax_set_main center <?php echo e($image->main ? 'btn-info' : ''); ?>" href="#" title="Сделать Главным">
                                        ...
                                        <div class="btn btn-mini check">
                                            <input type="checkbox" class="selected_images" value="<?php echo e($image->id); ?>" id="img_<?php echo e($image->id); ?>" name="img[]">
