            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item  mr-auto"><a class="nav-link nav-menu-main update_header_menu d-flex align-items-center gap-custom-1" href="{{route('admin.settings')}}"><i class="ficon feather icon-settings"></i> Sayt
                                sozlamalari</a></li>
                        <li class="nav-item  mr-auto"><a class="nav-link nav-menu-main update_header_menu d-flex align-items-center gap-custom-1" target="_blank" href="{{route('home')}}"><i class="ficon feather icon-external-link"></i>
                                Saytga o'tish </a></li>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            $user = auth()->user();
                            @endphp
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ $user->name}}</span><span class="user-status">{{ $user->status ? 'Active' : 'Inactive'}}</span></div>
                            <span><img class="round" src="{{asset('assets/admin')}}/app-assets/images/portrait/small/icon.png" alt="avatar" height="40" width="40"></span>
                        </a>
